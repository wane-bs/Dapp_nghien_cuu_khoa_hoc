# HỢP ĐỒNG CHO THUÊ SÁCH (P2P) – SMART‑LEGAL‑CONTRACT (BẢN MẪU)
...
1.  **Bên Cho Thuê (BCT):** [Họ tên/Pháp nhân] — [CMND/CCCD/MST] — [Địa chỉ] — [Email/Điện thoại].
2.  **Bên Thuê (BT):** [Họ tên/Pháp nhân] — [CMND/CCCD/MST] — [Địa chỉ] — [Email/Điện thoại].
3.  **Nền tảng (Operator):** [Tên pháp nhân vận hành] — Mã số DN: [xxx] — Trụ sở: [xxx] — Liên hệ: [email/tổng đài].
...
1.  **Trả trễ:** tính phí trễ theo ngày đến khi hoàn trả (theo Phụ lục 1).
...
3.  **Thời gian hoàn tiền qua PSP:** [x] ngày làm việc.

### Điều 7. Khiếu nại và giải quyết tranh chấp
1.  Mở ticket trong [x] ngày; nền tảng phản hồi trong [x] giờ; SLA xử lý [x] ngày.
2.  **Tranh chấp:** Thương lượng → Hòa giải qua nền tảng → [Trọng tài/Tòa án] tại Việt Nam.
...
## PHỤ LỤC 1 — BẢNG PHÍ & THANG HƯ HẠI (MẪU)
*   **Phí thuê/ngày:** [x] VND • **Đặt cọc:** [y] VND • **Phí trễ/ngày:** [z] VND
*   **Thang hư hại:**
    *   **Mức 1** (rách <2cm, cong mép nhẹ): trừ [a]% cọc.
    *   **Mức 2** (bút mực/ố bẩn vài trang): trừ [b]% cọc.
    *   **Mức 3** (rách nhiều trang/bong gáy): trừ [c]% cọc.
    *   **Mất sách:** bồi thường giá thay thế + phí xử lý [..].

## PHỤ LỤC 2 — CHÍNH SÁCH HOÀN TIỀN & HỦY
*   **Trước giờ giao ≥24h:** hoàn 100%. • **<24h:** khấu trừ [..]%.
*   **Sau giao:** theo trạng thái thực tế (trễ/hư hại/mất mát).
*   **Quy trình hoàn tiền qua PSP;** thời gian hoàn: [x] ngày làm việc.

## PHỤ LỤC 3 — BIÊN BẢN GIAO/NHẬN ĐIỆN TỬ (MẪU)
**Mã HĐ:** [..] / **Listing ID:** [..] / **Rental ID:** [..] • **Timestamp:** [..]
...
| :--- | :--- | :--- |
| [Ký số/Click‑accept] | [Ký số/Click‑accept] | [Ký số/Click‑accept] |
